-- CreateEnum
CREATE TYPE "EmailTokenType" AS ENUM ('REGISTRATION', 'EMAIL_CHANGE');

-- CreateEnum
CREATE TYPE "LoginStatus" AS ENUM ('SUCCESS', 'FAILED_PASSWORD', 'FAILED_LOCKED', 'FAILED_UNVERIFIED', 'FAILED_NOT_FOUND');
